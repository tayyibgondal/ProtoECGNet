...
def _train_or_test(model, dataloader, optimizer=None, class_specific=True, use_l1_mask=True,
    ...
    return auroc, total_cross_entropy / n_batches, total_cluster_cost / n_batches, total_separation_cost / n_batches, l1, p_avg_pair_dist.item()
...
def train(model, dataloader, optimizer, class_specific=False, coefs=None, log=print):
    ...
    log('\ttrain')
    model.train()
    auroc, ce, cc, sc, l1, p_pair_dist = _train_or_test(model=model, dataloader=dataloader, optimizer=optimizer, class_specific=class_specific, coefs=coefs, log=log)
