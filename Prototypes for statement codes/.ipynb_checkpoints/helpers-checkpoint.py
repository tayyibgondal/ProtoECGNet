...
def list_of_distances(X, Y):
    ...
    Y: A tensor of shape (M,D), where M is the number of samples and D is the dimensionality of each sample.
    return: A tensor of shape (N,M) containing the pairwise Euclidean distances between the samples in X and Y.
    '''
