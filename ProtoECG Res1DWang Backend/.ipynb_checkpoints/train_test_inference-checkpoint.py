...
from settings import experiment_run, img_size, log_dir, prototype_shape, label_index_to_label_text_mapping, num_prototypes_for_each_class

# Construct the log file name
log_file_name = os.path.join(log_dir, 'results-' + '-' + experiment_run + '.txt')
