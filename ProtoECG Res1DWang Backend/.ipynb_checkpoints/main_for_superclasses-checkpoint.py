...
from settings import train_information, test_information, num_train_examples, num_test_examples
...
train_dataset = PTBXL_Dataset(train_information)
# Initialize dataset and dataloader for testing
test_dataset = PTBXL_Dataset(test_information)
...
for epoch in range(num_train_epochs):
    ...
    if epoch >= push_start and epoch in push_epochs:
        ...
        prototype_dat_filename_prefix=prototype_img_filename_prefix,
